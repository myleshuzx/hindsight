...
_LANGUAGE_AND_NAME_RULES = """## LANGUAGE AND NAME PRESERVATION

- Determine the primary natural language of the new facts, and write observation text in that same language unless an explicit output language is requested.
- Preserve personal names, place names, nicknames, organization names, and titles exactly as written in the source facts.
- If source facts are Chinese, observation text must remain Chinese.
